...
FEATURE_CONTRACTS = {
    ...
    "projects_and_documents": {
        "routes": {("GET", "/projects"), ("POST", "/projects"),
                   ...
                   ("POST", "/corpora"), ("GET", "/corpora"),
                   ("GET", "/corpora/{corpus_id}"),
                   ("PUT", "/corpora/{corpus_id}/files"),
                   ("POST", "/corpora/{corpus_id}/finalize"),
        ...
        "tests": {"test_gui_management_api_complete_flow",
                  ...
                  "test_folder_corpus_api_import_finalize_and_execution_scope",
                  "test_folder_corpus_api_rejects_traversal_and_unfinalized_submission"},
    },
...
CAPABILITY_MODES = {
    "filesystem": {"read": "sync-read", "write": "sync-mutation", "append": "sync-mutation", "list_dir": "sync-read", "delete": "sync-mutation"},
