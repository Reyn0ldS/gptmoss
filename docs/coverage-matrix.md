...
| Planification fonctionnelle | `planners/simple.py`, `core/workload.py`, `core/plan_obligations.py`, `core/corpus_policy.py`, `planners/complexity.py`, `planners/fallbacks.py`, domains, execution | mode auto/direct/équipe, politique corpus, obligations explicites, réparation causale, partitions dynamiques et titres | contexte, autonomie, délégation, concurrence | `test_generic_planning_and_context`, `test_plan_obligations`, `test_planning_modes`, `test_lifecycle_chronology`, `test_runtime_ux` |
