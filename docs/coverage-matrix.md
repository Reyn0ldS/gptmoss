...
| Planification fonctionnelle | `planners/simple.py`, `core/workload.py`, `core/plan_obligations.py`, `planners/complexity.py`, `planners/fallbacks.py`, domains, execution | mode auto/direct/équipe, obligations sémantiques, graphe opérationnel, partitions dynamiques et titres | contexte, autonomie, délégation | `test_generic_planning_and_context`, `test_plan_obligations`, `test_planning_modes`, `test_lifecycle_chronology`, `test_runtime_ux` |
