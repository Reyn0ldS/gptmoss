...
La réécriture globale liée à des citations montrées dans du code Markdown n'est sélectionnée qu'en l'absence d'une obligation plus précise. Si une source obligatoire manque encore, l'ajout d'une citation probante bornée est prioritaire et préserve le document existant.
