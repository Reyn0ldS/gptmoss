...
Le profil professionnel vérifie aussi les additions entières explicitement écrites. Un total incohérent produit un préfixe de paragraphe réparable et impose `filesystem.replace_paragraph` au rôle propriétaire, sans réécrire le livrable complet.
